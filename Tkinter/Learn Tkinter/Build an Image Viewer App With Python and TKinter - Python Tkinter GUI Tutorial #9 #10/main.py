...
def click_run():
    ...
    # Main window
    win = Tk()
    win.iconbitmap("./Favicon/favicon.ico")
    ...
    # Image paths
    image1 = "./Image/ashe.jpg"
    image2 = "./Image/jhin.jpg"
    image3 = "./Image/teemo.jpg"
    image4 = "./Image/yasuo.jpg"
    image5 = "./Image/poppy.jpg"
    ...
    # Image button before
    bt_before_img = resize_image("./Image/before.png", image_width_b, image_height_b)
    button_before = Button(win, image=bt_before_img, border=5,command=button_bf)
    button_before.grid(column=0, row=2,pady=40)

    # Image button after
    bt_after_img = resize_image("./Image/after.png", image_width_b, image_height_b)
