...
# 2 : => Vì khi tèo ghi thì con trỏ nó đã trỏ xuống cuối file nên khi tèo đọc file thì nó sẽ rỗng => Khắc Phục : tèo ghi xong tèo phải đóng file để con trỏ trở về vị trị đầu file or sử dụng phương thức seek
